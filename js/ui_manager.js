...
const UIManager = (() => { // Using an IIFE to create a module-like structure
    ...
    function init() {
        ...
        DOM.handCountDisplay = document.getElementById('hand-count-display'); // Ensure this ID exists
    ...
    return {
        ...
        updateDeckInfo, // Now takes handCount
